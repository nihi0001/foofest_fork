        ...
        {/* filter knapper efter ugedage */}
          <div className="flex justify-center flex-wrap my-8 mb-28 gap-5">
            {days.map((day) => (
              <button
                key={day}
                className={`text-lg font-bold xl:text-2xl px-6 xl:px-8 py-1 xl:py-2 text-White rounded-full bg-Hotpink uppercase transition ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-Lightpink duration-300 cursor-pointer focus:text-White mt-3`}
