...
export default function GuestForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const bodyContent = JSON.stringify(info);
    let headersList = {
      "Accept": "*/*",
    ...
    try {
      const response = await fetch("https://uvfmifhkbamwmagnqhri.supabase.co/rest/v1/FooFestBooking", { 
        method: "POST",
        body: bodyContent,
        headers: headersList
      });
  ...
  return (
    <div className="mt-10">
      <form onSubmit={handleSubmit} className="m-6">
        ...
        <button 
          type="submit" 
          className="text-center text-White p-2 mt-6 rounded-lg bg-Hotpink hover:bg-Lightoink w-60"
          disabled={isLoading}
        >
