  ...
  return (
    <div className="max-w-5xl mx-auto mb-24 p-4">
      <div className="flex flex-col items-center ">
        <h2 className={`text-White text-4xl md:text-5xl mb-12 text-center ${BowlbyOne.className}`}>LATEST FESTIVAL ANNOUNCEMENTS</h2>
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-9  text-White">
          ...
          <div className="bg-Navyblue rounded-xl  hover:bg-Hotpink transition duration-300 border-2 border-Hotpink">
            ...
            <div className="p-5">
              ...
              <p className="text-md">Plan FOO Festival 2024 down to the details with our completed schedule. Get ready for pulsating beats, mesmerizing light shows, and world-class DJs at this techno festival.
              </p>
            </div>
          </div>
        </div>
